...
<head>
    ...
    <style type="text/css">
        ...
        .rounded > table > tbody > tr > td > table {
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td style="width:131px;">
                                                ...
                                                <img src="https://portal.waldorf-augsburg.de/assets/img/logo.png"
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                        <h1 style="font-family: Helvetica, Arial, sans-serif; font-size: 22px; font-weight: bold; text-align: center;">
                                            Portal der Freien Waldorfschule und Waldorfkinderg&auml;rten Augsburg e.
                                            V.</h1></div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <td align="left"
                                    ...
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                        <p style="font-family: Helvetica, Arial, sans-serif; font-size: 11px;"><span
                                                    style="font-size: 14px;"><strong>Passwort zur&uuml;cksetzen</strong></span>
                                        </p></div>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                        <p style="font-family: Helvetica, Arial, sans-serif; font-size: 11px;"><span
                                                    style="font-size: 12px;">Hallo <?= $name ?>,</span></p>
                                        <p style="font-family: Helvetica, Arial, sans-serif; font-size: 11px;">
                                            &nbsp;</p>
                                        <p style="font-family: Helvetica, Arial, sans-serif; font-size: 11px;"><span
                                                    style="font-size: 12px;">f&uuml;r das Konto</span><span
                                                    style="font-size: 12px;"> <?= $username ?> wurde eine Passwortzur&uuml;cksetzung angefordert! Klicke auf den untenstehenden Button, um das Passwort zur&uuml;ckzusetzen.&nbsp;</span>
                                        </p>
                                        <p style="font-family: Helvetica, Arial, sans-serif; font-size: 11px;">
                                            &nbsp;</p>
                                        <p style="font-family: Helvetica, Arial, sans-serif; font-size: 11px;"><span
                                                    style="font-size: 12px;">Wenn du keine Passwortzur&uuml;cksetzung angefordert hast, ignoriere diese E-Mail bitte.&nbsp;</span><span
                                                    style="font-size: 12px;">Es besteht <span
                                                        style="text-decoration: underline;">keine Gefahr</span> f&uuml;r dein Konto!</span>
                                        </p></div>
                            ...
                            <tr>
                                <td align="center" vertical-align="middle"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td align="center" bgcolor="#0A4596" role="presentation"
                                                style="border:none;border-radius:8px;cursor:auto;font-style:normal;mso-padding-alt:10px 20px 10px 20px;background:#0A4596;"
                                                valign="middle">
                                                <a href="<?= $link ?>"
                                                   style="display: inline-block; background: #0A4596; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-weight: normal; line-height: 100%; margin: 0; text-decoration: none; text-transform: none; padding: 10px 20px 10px 20px; mso-padding-alt: 0px; border-radius: 8px;"
                                                   target="_blank">
                                                    <span>Passwort zur&uuml;cksetzen</span>
                                                </a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1.5;text-align:left;color:#000000;">
                                        <p style="font-family: Helvetica, Arial, sans-serif; font-size: 11px;">&copy;
                                            2025 Freie Waldorfschule und Waldorfkinderg&auml;rten Augsburg e. V.<br><a
                                                    ...
                                                    rel="noopener" style="color: #0000EE;">Datenschutz</a></p></div>
