        ...
        <section class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-1 dark:text-gray-400 text-gray-700 font-inter-medium ">
                ...
                <select name="category" id="category"
                        class=" p-2.5 lg:p-3 select rounded w-full bg-neutral-100 dark:bg-slate-900 border-none focus:outline-none">
            ...
            <section>
                ...
                <div class="bg-neutral-100 dark:bg-slate-900 rounded p-3 grid grid-cols-2 place-items-center gap-3">
                    ...
                    <div class="flex items-center gap-3 dark:text-gray-400 text-gray-700 font-inter-medium">
