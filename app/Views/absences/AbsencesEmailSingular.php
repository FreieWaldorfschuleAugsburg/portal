                        ...
                        <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    <table class="card login" role="presentation" border="0" cellpadding="0"
                                           cellspacing="0"
                                           style="border-radius: .5rem !important; border-collapse: separate !important; width: 100%; overflow: hidden; max-width: 330px; text-align: center !important; box-shadow: 0 1rem 3rem rgba(0,0,0,.175) !important; margin: auto; border: 1px solid #e2e8f0;"
                                           bgcolor="#ffffff">
                                        <tbody>
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                        ...
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                            ...
                                                            <center>
                                                                <img class="navbar-brand-logo"
                                                                     src="https://portal.waldorf-augsburg.de/assets/img/waldorf_logo.png"
                                                                     alt="FWA Logo"
                                                                     style="height: 64px; line-height: 100%; outline: none; text-decoration: none; display: block; width: 64px; border-style: none; border-width: 0;">
                                                            ...
                                                            <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                               align="left">
                                                                es ist eine neue Abwesenheit ausstehend!<br>
                                                                <br>
                                                                Um die neue Abwesenheit zu pr&#252;fen, <a
                                                                        href="https://portal.waldorf-augsburg.de/absences/admin"
                                                ...
                                                <div class="card-footer footer-plain text-center"
                                                     ...
                                                     align="center">
                                                    <small>&#169; 2024 Freie Waldorfschule und <br>
                                                        Waldorfkinderg&#228;rten Augsburg e. V.<br>
                                                        <a href="https://waldorf-augsburg.de/impressum"
                                                           style="color: #0d6efd;">Impressum</a> &#8211;
                                                        <a href="https://waldorf-augsburg.de/datenschutz"
                                                           style="color: #0d6efd;">Datenschutz</a>
                                                    </small>
                                                </div>
