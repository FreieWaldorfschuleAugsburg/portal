    ...
    <div class="flex flex-col gap-3">
        <section class="flex flex-col gap-2">
            <div class="flex flex-col gap-1 dark:text-gray-400 text-gray-700 font-inter-medium">
                <label for="title" class=""><?= lang('credential.fields.title') ?></label>
                ...
                <div class="flex flex-col gap-2 w-full" id="dynamicFields">
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="flex flex-col gap-1 w-full">
                            ...
                            <input type="text" name="value[]" id="field_value[]"
                                   class="rounded p-2.5 lg:p-3 bg-neutral-100 dark:bg-slate-900 border-none focus:outline-none">
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <button class="bg-blue-600 text-white p-3 rounded font-inter-medium flex-grow" id="addField" type="button">
                    Hinzufügen
                </button>
...
<script>
    ...
    const inputFieldHTML = `<div class="grid grid-cols-2 gap-3"><div class="flex flex-col gap-1 w-full"><label for="title" class="font-inter-medium text-gray-400"><?= lang('credential.fields.fieldname') ?></label><input type="text" name="field_name[]" id="field_name[]" class="rounded p-2.5 lg:p-3 bg-neutral-100 dark:bg-slate-900 border-none focus:outline-none"></div><div class="flex flex-col gap-1 w-full"><label for="title" class="font-inter-medium text-gray-400"><?= lang('credential.fields.value') ?></label><input type="text" name="value[]" id="value[]" class="rounded p-2.5 lg:p-3 bg-neutral-100 dark:bg-slate-900 border-none focus:outline-none"></div></div>`
